	 	...
	 	$.ajax({
	        ...
	        success: function(data) {
	       		$.each(data.resultList, function(i,n){
			   		if(i<3) {
						$(".phb_xx1").append('<tr class="phb_tr"><td align="center"><div class="pm1">'+(i+1)+'</div></td><td align="center" width="180"><div style="display:block" id="phb_bt">'+n.gameName+'</div><div style="display:none;text-align:center;" id="phb_content"><dl><dt>'+n.gameName+'</dt><dt><a target="_blank" href="product/'+n.id+'.htm"><img src="'+n.gameImg+'" width="64" height="64"/></a></dt><dd>大小：'+n.fileSize+' &nbsp; 系统：'+n.osTypes+'</dd></dl></div></td><td align="center">'+n.procductsTypes+'</td><td align="center">'+n.clickCount+'</td></tr>');
			   		} else{
